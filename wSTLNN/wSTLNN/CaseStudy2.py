...
def NeighborsToFiles(neighbors):
    paths = {"Albury": "weather_data/albury.xlsx",
            "BadgerysCreek": "weather_data/badgeryscreek.xlsx",
            "Cobar": "weather_data/cobar.xlsx",
            "CoffsHarbour": "weather_data/coffsharbour.xlsx",
            "Moree": "weather_data/moree.xlsx",
            "Newcastle": "weather_data/newcastle.xlsx",
            "NorahHead": "weather_data/norahhead.xlsx",
            "NorfolkIsland": "weather_data/norfolkisland.xlsx",
            "Penrith": "weather_data/penrith.xlsx",
            "Richmond": "weather_data/richmond.xlsx",
            "Sydney": "weather_data/sydney.xlsx",
            "SydneyAirport": "weather_data/sydneyairport.xlsx",
            "WaggaWagga": "weather_data/waggawagga.xlsx",
            "Williamtown": "weather_data/williamtown.xlsx",
            "Wollongong": "weather_data/wollongong.xlsx",
            "Canberra": "weather_data/canberra.xlsx",
            "Tuggeranong": "weather_data/tuggeranong.xlsx",
            "MountGinini": "weather_data/mountginini.xlsx",
            "Ballarat": "weather_data/ballarat.xlsx",
            "Bendigo": "weather_data/bendigo.xlsx",
            "Sale": "weather_data/sale.xlsx",
            "MelbourneAirport": "weather_data/melbourneairport.xlsx",
            "Melbourne": "weather_data/melbourne.xlsx",
            "Nhil": "weather_data/nhil.xlsx",
            "Portland": "weather_data/portland.xlsx",
            "Dartmoor": "weather_data/dartmoor.xlsx",
            "Brisbane": "weather_data/brisbane.xlsx",
            "Cairns": "weather_data/cairns.xlsx",
            "GoldCoast": "weather_data/goldcoast.xlsx",
            "Townsville": "weather_data/townsville.xlsx",
            "Adelaide": "weather_data/adelaide.xlsx",
            "MountGambier": "weather_data/mountgambier.xlsx",
            "Nuriootpa": "weather_data/nuriootpa.xlsx",
            "Woomera": "weather_data/woomera.xlsx",
            "Albany": "weather_data/albany.xlsx",
            "Witchcliffe": "weather_data/witchcliffe.xlsx",
            "PearceRAAF": "weather_data/pearceraaf.xlsx",
            "PerthAirport": "weather_data/perthairport.xlsx",
            "Perth": "weather_data/perth.xlsx",
            "SalmonGums": "weather_data/salmongums.xlsx",
            "Walpole": "weather_data/walpole.xlsx",
            "Hobart": "weather_data/hobart.xlsx",
            "Launceston": "weather_data/launceston.xlsx",
            "AliceSprings": "weather_data/alicesprings.xlsx",
            "Darwin": "weather_data/darwin.xlsx",
            "Katherine": "weather_data/katherine.xlsx",
            "Uluru": "weather_data/uluru.xlsx"
    }
...
def main():
    ...
    tl_nn_operators = TL_NN_Operators(T, M, n)
    optimizer_operators = torch.optim.RMSprop(tl_nn_operators.parameters(), lr=learning_rate)
    ...
    for epoch in range(Epoch):
        for d_i in range(train_size // batch_size + 1):
            ...
            X_btpred = tl_nn_operators(X_bt)
            k = tl_nn_operators.operators()
            print(k)
            # print(X_btpred)
            # print(y_bt)
...
if __name__ == "__main__":
    ...
    print(NeighborsToFiles(neighbors))
